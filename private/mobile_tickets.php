...
<!-- RSL Schedule -->
<div class="tab-pane fade show active" id="rsl-mobile-schedule" role="tabpanel" aria-labelledby="rsl-schedule">
...
<!-- URFC Schedule -->
<div class="tab-pane fade" id="urfc-mobile-schedule" role="tabpanel" aria-labelledby="urfc-schedule">
<section class="card mb-1" id="tickets">
  <?php $u = 1;
...
<!-- Monarchs Schedule -->
<div class="tab-pane fade" id="monarchs-mobile-schedule" role="tabpanel" aria-labelledby="monarchs-schedule">
<section class="card mb-1" id="tickets">
  <?php
  $m = 1;

...
if(is_post_request()) {
  ...
  if($result === true) {
    ...
    redirect_to(url_for('/staff/posts/academy.php'));
  } else {
    // show errors
...
<div id="content">
  <div class="tasks listing mb-5">
    <h1>RSL Academy Highlighed Posts</h1>
    <?php echo display_errors($post->errors); ?>
      ...
      <?php foreach($highlighed as $highlight) { ?>
        <tr>
          <form action="<?php echo 'academy.php?id=' . h(u($highlight->id)) ; ?>" method="post">
  ...
  <div class="tasks listing">
    ...
    <?php echo display_errors($post->errors); ?>
      ...
      <?php foreach($posts as $post) { ?>
        <tr>
          <form action="<?php echo 'academy.php?id=' . h(u($post->id)) ; ?>" method="post">
...
$url = url_for('/staff/posts/academy.php');

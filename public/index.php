...
<div class="row">
    ...
    <section class="card mb-5" id="urfc">
      <div class="card-header">
        <div class="d-flex">
          ...
          <div class="my-auto"><a href="https://www.rsl.com/topics/utah-royals" target="_blank">See All &raquo;</a></div>
        </div>
      </div>
        ...
        <div class="card-footer text-center">
          <a class="card-link text-center" href="https://www.rsl.com/topics/utah-royals" target="_blank">See All</a>
        </div>
    ...
    <section class="card mb-5" id="monarchs">
      <div class="card-header">
        <div class="d-flex">
          ...
          <div class="my-auto"><a href="https://www.rsl.com/topics/real-monarchs" target="_blank">See All &raquo;</a></div>
        </div>
      </div>
        ...
        <div class="card-footer text-center">
          <a class="card-link text-center" href="https://www.rsl.com/topics/real-monarchs" target="_blank">See All</a>
        </div>
    ...
    <section class="card mb-5" id="academy">
      <div class="card-header">
        <div class="d-flex">
          ...
          <div class="my-auto"><a href="https://www.rsl.com/topics/rsl-academy" target="_blank">See All &raquo;</a></div>
        </div>
      </div>
        ...
        <div class="card-footer text-center">
          <a class="card-link text-center" href="https://www.rsl.com/topics/rsl-academy" target="_blank">See All</a>
        </div>
  ...
  <div class="col-lg-4 d-none d-lg-block">
    ...
    <div class="card p-3 sticky-top">
      ...
      <?php //require_once('../private/tickets/index.php'); ?>
